             ...
             <div class="col-md-8 col-lg-10 order-md-last">
                ...
                <div id="paging"><%@include file="paging.jsp"%>
                  ...
                  <c:if test="${page gt 10 }">
                     <button onclick="location.href='myRecipe?page=${page-10 }'">이전</button>
                  </c:if>
                  <c:if test="${page eq 1 }">
                     <button disabled="disabled">◀</button>
                  </c:if>
                  <c:if test="${page gt 1 }">
                     <button onclick="location.href='myRecipe?page=${page-1 }'">◀</button>
                  </c:if>
                  <c:forEach var="i" begin="${startPage }" end="${endPage }">
                     ...
                     <c:if test="${i ne page }">
                        <button onclick="location.href='myRecipe?page=${i }'">${i }</button>
                     </c:if>
                  </c:forEach>
                  ...
                  <c:if test="${page lt totalPage-9 }">
                     <button onclick="location.href='myRecipe?page=${page+10 }'">다음</button>
                  </c:if>
